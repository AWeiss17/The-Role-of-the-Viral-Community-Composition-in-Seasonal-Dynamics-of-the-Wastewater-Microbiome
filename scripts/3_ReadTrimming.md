# Read Trimming
With the following script, paired-end FASTQ files were trimmed using Trim Galore, applying a quality threshold and clipping bases from 3’ end of each read.
```bash
#!/bin/bash
